...
const ArrowUp=()=>{
    ...
    <path d="M2.73 27L0 23.85L14.43 7.0875L22.23 16.0875L32.37 4.5H27.3V0H39V13.5H35.1V7.65L22.23 22.5L14.43 13.5L2.73 27Z" fill="#00B368" fill-opacity="0.31"/>
    </svg>
...
const ArrowDown=()=>{
    ...
    <path d="M26.6 23V19.1667H31.54L21.66 9.29583L14.06 16.9625L0 2.68333L2.66 0L14.06 11.5L21.66 3.83333L34.2 16.4833V11.5H38V23H26.6Z" fill="#BE4141" fill-opacity="0.6"/>
    </svg>
